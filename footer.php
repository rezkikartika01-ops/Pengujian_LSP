    ...
    <div class="ji gp">
      <div class="tc uf ap gg fp">
        <div class="animate_top zd/2 to/4">
          <a href="index.html">
            <img src="images/logo_pt.png" alt="Logo" class="om" />
            <img src="images/logo_pt_dark.png" alt="Logo" class="xc nm" />
          </a>

          <p class="lc fb">Internet Service Provider & Network Solutions</p>
