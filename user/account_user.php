...
?>
                        <tr>
                          ...
                          <td class="text-center"><img src="../admin/uploads/<?= htmlspecialchars($data['foto']); ?>" width="80" height="80" style="object-fit:cover; "></td>
                      ...
                      Hapus
                            ...
                            <a href="edit_user.php?id=<?= $data['id_user']; ?>"><button class="mdc-button mdc-button--raised filled-button--warning">
                      Edit
                    </button></a>
                          </td>
                        </tr>
