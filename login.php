      ...
      <section class="i pg fh rm ki xn vq gj qp gr hj rp hr">
        ...
        >
          ...
          <div class="rj">
            ...
            <p>Pastikan akunmu sesuai!</p>
          </div>

          <form form class="sb" action="login_proses.php" method="POST">
            <div class="wb">
              <label class="rc kk wm vb" for="username">Username</label>
              <input type="text" name="username" id="username" placeholder="example@gmail.com" class="vd hh rg zk _g ch hm dm fm pl/50 xi mi sm xm pm dn/40" />
            </div>

            <div class="wb">
              <label class="rc kk wm vb" for="password">Password</label>
              <input type="password" name="password" id="password" placeholder="**************" class="vd hh rg zk _g ch hm dm fm pl/50 xi mi sm xm pm dn/40" />
            </div>
