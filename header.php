  ...
  <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
    <div class="vd to/4 tc wf yf">
      <a href="index.html">
        ...
        <img class="xc nm" src="images/logo_pt_dark.png" alt="Logo Dark" />
      </a>
    ...
    >
      <nav>
        <ul class="tc _o sf yo cg ep">
          ...
          <li><a href="daftar.php" class="xl">Berlangganan</a></li>
        </ul>
      </nav>
      ...
      <div class="tc wf ig pb no">
        ...
        <a href="daftar.php" :class="{ 'hh/[0.15]' : page === 'home', 'sh' : page === 'home' && stickyMenu }" class="lk gh dk rg tc wf xf _l gi hi">Sign Up</a>
      </div>
    </div>
  </div>
</header>
        ...
        <div class="bb ze ki xn 2xl:ud-px-0">
          <div class="tc _o">
            <div class="animate_left jn/2">
              <h1 class="fk vj zp or kk wm wb">Internet Service Provider & Network Solutions</h1>
              <p class="fq">
                PT Solusi Net Nusantara memiliki keunggulan melalui tim teknis yang profesional, infrastruktur jaringan yang andal, layanan pelanggan yang responsif, serta kemampuan menyediakan solusi yang fleksibel dan sesuai kebutuhan pelanggan.
              </p>

              <div class="tc tf yo zf mb">
                <a href="product.php" class="ek jk lk gh gi hi rg ml il vc _d _l"
                  >Get Started Now</a
                >

                <span class="tc sf">
                  <a href="#" class="inline-block ek xj kk wm"> Call us (0811) 1137 – 005 </a>
